<template>
  <div class="new-plants w-100 position-relative pt-2 pl-5 pr-5">
    <div class="header-content">
      <p class="pb-2 h2">New Plants</p>
      <p class="text-justify fa-14 pb-4">
        Our selection of new plants bring beautifully blooming flowers and hints
        of gorgeous greenery. We offer fresh plants for every occasion.
      </p>
    </div>

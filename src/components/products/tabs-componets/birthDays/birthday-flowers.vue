<template>
  <div class="birthday-flowers w-100 position-relative pt-2 pl-5 pr-5">
    <div class="header-content">
      <p class="h3 py-2">Birthday Flowers</p>
    ...
    <div class="footer-content mt-4">
      ...
      <p class="text-justify fa-13">
        ...
        paired with gifts and goodies, SU-Bouquets has your birthday shopping
        covered.
      </p>
      ...
      <p class="text-justify fa-13">
        Trust SU-Bouquets to help you deliver some birthday love to that special

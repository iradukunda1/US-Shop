    ...
    <div class="row d-flex justify-content-center pb-5">
      <div class="paymentCont">
        <div class="headingWrap">
          ...
          <p class="text-center">
            Please confirm your payment method by select one below
            <i class="fa p-1 fa-angle-double-down text-success fadeOutDown"></i>
          </p>
        </div>
